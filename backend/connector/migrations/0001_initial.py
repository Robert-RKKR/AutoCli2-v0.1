    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.ManyToManyField(help_text='One or more software(s) can be added to the connection template. To associate the template with the appropriate software(s). Template execution will only be available to hosts belonging to the specified software.', to='inventory.platform', verbose_name='Software')),
            ],
            options={
