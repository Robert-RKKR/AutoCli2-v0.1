# Generated by Django 4.1.4 on 2023-02-05 15:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.IntegerField(choices=[(0, '---'), (1, 'CRITICAL'), (2, 'ERROR'), (3, 'WARNING'), (4, 'INFO'), (5, 'DEBUG')], default=0, help_text='The level of severity of the performed action.', verbose_name='Severity level')),
                ...
                ('administrator', models.ForeignKey(help_text='Administrator responsible for provided object.', on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Administrator')),
            ],
            options={
