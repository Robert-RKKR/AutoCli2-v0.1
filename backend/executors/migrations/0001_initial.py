...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('connectors', '0004_rename_certificate_connectiontemplate_http_pagination_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connection_templates', models.ManyToManyField(blank=True, help_text='Xxx.', null=True, to='connectors.connectiontemplate', verbose_name='Xxx')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connection_templates', models.ForeignKey(help_text='Xxx.', on_delete=django.db.models.deletion.PROTECT, to='connectors.connectiontemplate', verbose_name='Xxx')),
                ...
                ('executor', models.ForeignKey(help_text='Xxx.', on_delete=django.db.models.deletion.PROTECT, to='executors.executor', verbose_name='Xxx')),
