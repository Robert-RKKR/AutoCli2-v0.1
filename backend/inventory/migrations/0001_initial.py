    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ManyToManyField(blank=True, help_text='Related tag.', to='inventory.tag', verbose_name='Tag')),
            ],
            options={
                'verbose_name': 'Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, default='IdentificationModel default description.', error_messages={'invalid': 'Enter the correct description value. It must contain 8 to 256 digits, letters and special characters -, _, . or spaces.'}, help_text='IdentificationModel description.', max_length=256, null=True, validators=[autocli2.base.validators.base_validator.DescriptionValueValidator()], verbose_name='Description')),
                ('ico', models.IntegerField(default=1, help_text='IdentificationModel graphical representation.', verbose_name='IdentificationModel ico')),
                ('is_http_supported', models.BooleanField(default=False, help_text='Is HTTP(S) protocol supported by platform.', verbose_name='Is HTTP(S) supported')),
                ('is_ssh_supported', models.BooleanField(default=False, help_text='Is SSH protocol supported by platform.', verbose_name='Is SSH supported')),
        ...
        migrations.AddField(
            model_name='host',
            name='platform',
            field=models.ForeignKey(default=1, help_text='Platform associated with current host.', on_delete=django.db.models.deletion.PROTECT, to='inventory.platform', verbose_name='Platform'),
        ),
        migrations.AddField(
            model_name='host',
            name='site',
